...
grid_name = "grids/cells25x25_hv.ugx"
spatial_num_ref = 2
...
-- <Test-Section>
conductivity_sigma_i_x = 1e-6-- 4.0e-8 --3e-6 -- 4.2857142857143e-08
conductivity_sigma_i_y = 2.5e-9 --4.0e-8 -- 5e-7 -- 2.013698630137e-07
conductivity_sigma_e_x = 5e-07 -- 1e-6
conductivity_sigma_e_y = 5e-07 -- 1e-6
chi = 0.25 -- 0.25
-- </Test Section>
